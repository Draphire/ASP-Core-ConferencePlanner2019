 ...
 namespace BackEnd.Data
 {
     ...
     {
         //take speaker object and turn into speakerresponse by copying over the id name etc
         //session use joint table and bring them back, called Link Language integrated natural query with 
         //lamda function take whatever objct session speaker and want to return a new session and put inside the session objecct 
